...
const Features = () => {
  return (
    <div className="relative mt-[80px]">
        ...
        <div className="container  px-4 mx-auto py-24">
          <div className="text-center">
            ...
            <p className="md:text-lg text-sm max-w-4xl mx-auto mt-6 text-[#EAECF0]">
              Wokpa gives you everything yoyu need to host, provide and track
              your podcast.
            </p>
          </div>
      ...
      <section>
        <div className="container  px-4 mx-auto py-24">
          <div className="text-center">
            ...
            <p className="md:text-lg text-sm max-w-4xl mx-auto mt-6 text-[#EAECF0]">
              Wokpa records audio mp3 to give you the picture-perfect quality
              that your video podcast deserves.Record in 16-bit 48k WAV audio
              track per guest, regardless of internet connection (local
              recording), with no time limits.
            </p>
          </div>
              ...
              <div className="md:block flex rounded-xl bg-[#18181B] py-12 px-10 w-56 text-center w-full items-center gap-6">
                ...
                >
                  <g filter="url(#filter0_b_2977_88960)">
                    ...
                    />
                    <path
                      d="M36.5008 31.2002H44.5008C45.3495 31.2002 46.1634 31.5373 46.7635 32.1375C47.3636 32.7376 47.7008 33.5515 47.7008 34.4002C47.7008 35.2489 47.3636 36.0628 46.7635 36.6629C46.1634 37.2631 45.3495 37.6002 44.5008 37.6002H28.5008C27.6521 37.6002 26.8382 37.2631 26.238 36.6629C25.6379 36.0628 25.3008 35.2489 25.3008 34.4002C25.3008 33.5515 25.6379 32.7376 26.238 32.1375C26.8382 31.5373 27.6521 31.2002 28.5008 31.2002H30.1008"
                      stroke="#F79009"
                      strokeWidth="2"
                      strokeLinecap="round"
                    />
                    <path
                      d="M31.7004 43.9996C31.7004 44.6361 31.4475 45.2466 30.9974 45.6967C30.5474 46.1468 29.9369 46.3996 29.3004 46.3996C28.6639 46.3996 28.0534 46.1468 27.6033 45.6967C27.1532 45.2466 26.9004 44.6361 26.9004 43.9996C26.9004 43.3631 27.1532 42.7526 27.6033 42.3026C28.0534 41.8525 28.6639 41.5996 29.3004 41.5996C29.9369 41.5996 30.5474 41.8525 30.9974 42.3026C31.4475 42.7526 31.7004 43.3631 31.7004 43.9996Z"
                      stroke="#F79009"
                      strokeWidth="2"
                    />
                    <path
                      d="M41.3 35.2V37.6M38.1 44H46.1M27.7 26.4L41.3 20M52.5 39.2C52.5 45.2336 52.5 48.2512 50.6248 50.1248C48.7512 52 45.7336 52 39.7 52H33.3C27.2664 52 24.2488 52 22.3752 50.1248C20.5 48.2512 20.5 45.2336 20.5 39.2C20.5 33.1664 20.5 30.1488 22.3752 28.2752C24.2488 26.4 27.2664 26.4 33.3 26.4H39.7C45.7336 26.4 48.7512 26.4 50.6248 28.2752C51.6712 29.32 52.1336 30.72 52.3368 32.8"
                      stroke="#F79009"
                      strokeWidth="2"
                      strokeLinecap="round"
                    />
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_2977_88960"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_2977_88960"
                        result="shape"
                      />
                    </filter>
                  </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_2978_89527"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_2978_89527"
                        result="shape"
                      />
                    </filter>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_2977_89347"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_2977_89347"
                        result="shape"
                      />
                    </filter>
                  </defs>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_2977_89354"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_backgroundBlur_2977_89354"
                        result="shape"
                      />
                    </filter>
                  </defs>
      ...
      <section
        style={{
          background: "linear-gradient(27deg, #005FF8 0%, #384459 100%)",
        }}
        className="relative bg-gradient-to-tr from-[#005FF8] to-[#384459]"
      >
        <div className="container  px-4 mx-auto py-24">
          ...
          <div className="mt-12 text-center">
            <Button className="text-lg font-semibold font-inter from-white to-white !text-secondary py-4 md:text-base text-sm">
              Try Wokpa for free
            </Button>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-10">
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M72.104 58.2023C57.0662 45.833 44.8812 31.1025 35.7246 13.9405C33.8933 10.5222 29.6322 9.21829 26.1809 11.0508C22.7648 12.8833 21.4615 17.1474 23.2928 20.601C33.365 39.384 46.6774 55.5241 63.1591 69.0916C66.1526 71.5584 70.625 71.1355 73.0902 68.1401C75.5555 65.1094 75.0975 60.6691 72.104 58.2023Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M64.0845 10.029C64.8593 24.266 65.5638 38.5031 66.4442 52.7402C66.6908 56.6166 70.0364 59.5768 73.9103 59.3301C77.7842 59.0834 80.7425 55.7356 80.4959 51.8592C79.6155 37.6573 78.911 23.4556 78.1362 9.21852C77.9249 5.35266 74.5793 2.37484 70.7054 2.59333C66.8315 2.81182 63.838 6.14197 64.0845 10.029Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M116.368 12.9192C107.353 26.522 97.1399 39.0674 86.8564 51.7539C84.3912 54.7845 84.8488 59.225 87.8775 61.6566C90.9062 64.1234 95.3438 63.6651 97.7738 60.6345C108.339 47.6308 118.834 34.6976 128.131 20.7072C130.279 17.4651 129.363 13.0954 126.123 10.9458C122.919 8.79613 118.516 9.67712 116.368 12.9192Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M151.292 63.4885C126.851 64.581 100.896 64.6162 76.455 63.0657C72.5811 62.8542 69.2355 65.7792 68.989 69.6908C68.7424 73.5673 71.7007 76.9151 75.5746 77.1618C100.509 78.7123 126.992 78.6771 151.926 77.5846C155.8 77.4084 158.828 74.096 158.652 70.2195C158.476 66.3431 155.166 63.3123 151.292 63.4885Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M63.14 67.9639C78.213 86.4298 93.8145 104.544 107.796 123.855C110.085 126.992 114.487 127.696 117.657 125.406C120.791 123.115 121.495 118.71 119.206 115.573C105.049 96.0503 89.2716 77.7254 74.0225 59.048C71.5573 56.0526 67.1197 55.5946 64.1262 58.0614C61.0975 60.5282 60.6748 64.9685 63.14 67.9639Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M67.7049 73.3214C71.6492 92.5626 72.741 110.958 73.0228 130.446C73.058 134.322 76.2628 137.423 80.1367 137.388C84.0459 137.318 87.1449 134.146 87.0745 130.234C86.7927 109.83 85.6307 90.6244 81.5103 70.467C80.7003 66.661 77.0025 64.194 73.1638 65.0046C69.3603 65.7798 66.8949 69.5155 67.7049 73.3214Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M74.6204 66.5893C51.9052 70.6067 29.2252 72.4391 6.36913 75.1526C2.49522 75.6108 -0.251738 79.0997 0.206088 82.9761C0.663914 86.8525 4.15076 89.6013 8.02467 89.1432C31.1273 86.4296 54.089 84.5266 77.0859 80.474C80.8894 79.7692 83.4603 76.1041 82.7911 72.2982C82.0868 68.457 78.4591 65.8845 74.6204 66.5893Z"
              fill="#4FFFEB"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M90.4272 55.8786C85.7432 55.6671 81.3058 55.3499 76.7275 54.6803C72.8536 54.1164 69.2966 56.7947 68.7331 60.6359C68.1697 64.4771 70.846 68.0717 74.6847 68.6355C79.756 69.3756 84.6513 69.728 89.7931 69.9394C93.667 70.1156 96.9773 67.12 97.1181 63.2084C97.2942 59.3319 94.3011 56.0548 90.4272 55.8786Z"
              fill="#4FFFEB"
            />
          </svg>
        </div>
              ...
              <div className="flex md:flex-row-reverse flex-col-reverse gap-24 items-center">
                <div className="md:w-6/12">
                  <div className="text-left">
                    ...
                    <div className="mt-4">
                      <Button className="font-inter py-2 font-semibold">
                        See more features
                      </Button>
                    </div>
                  </div>
            ...
            <div className="md:w-6/12">
              <div className="">
                ...
                <h2 className="md:text-5xl text-3xl font-raleway mt-8 leading-tight">
                  Wokpa has saved us thousands of hours of <br />
                  work. We’re able to spin up projects and features <br />{" "}
                  faster.
                </h2>
                <div className="mt-12">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div className="mt-1 text-[#D0D5DD]">Podcaster, ABR</div>
                    </div>
                    <div>
                      <svg
                        width="144"
                        ...
                        <defs>
                          ...
                          >
                            ...
                            <feComposite
                              in2="SourceAlpha"
                              operator="in"
                              result="effect1_backgroundBlur_4100_49353"
                            />
                            <feBlend
                              mode="normal"
                              in="SourceGraphic"
                              in2="effect1_backgroundBlur_4100_49353"
                              result="shape"
                            />
                          </filter>
                          <filter
                            id="filter1_b_4100_49353"
                            x="80"
                            y="-8"
                            width="72"
                            height="72"

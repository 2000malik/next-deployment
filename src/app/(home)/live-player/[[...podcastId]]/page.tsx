...
import { LiveViewAboutPodcastTab,LiveViewListOnTab ,EpisodeLiveView} from "@/src/app/(dashboard)/components/Episode";
    ...
    <div id="">
      <div className="h-[260px]">
        {podcast?.cover_picture_url ? (
          <img
            className="rounded-t-3xl h-[260px] w-full o object-cover"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 w-full px-10">
        <div className="w-full p-5 flex flex-col">
          <div className="!h-[206px] relative -top-32">
            {podcast?.picture_url ? (
              <img
                className="!w-[250px] !h-[250px] rounded-lg border-2 border-[#BEE7E4] object-cover"
                ...
                <div className="flex-1">
                  <div className="flex gap-4 items-center">
                    ...
                    <div className="text-sm font-medium">
                      <Link href="/dashboard">Podcasts</Link>
                    </div>
                    <div>
                      <svg
                        width="16"
                ...
                <Tab className="outline-none">
                  {({ selected }) => (
                    <div
                      className={`${
                        selected
                          ? "border-[#36FFE8] text-[#36FFE8]"
                          : "text-[#EAECF0] border-transparent"
                      } border-b-2 px-4 pb-2 ease transition-all text-sm`}
                    >
                      Episodes
                    </div>
                  )}
                    ...
                    <div
                      className={`${
                        selected
                          ? "border-[#36FFE8] text-[#36FFE8]"
                          : "text-[#EAECF0] border-transparent"
                      } text-sm px-4 pb-2 border-b-2 ease transition-all`}
                    >
                      About this podcast
                    </div>
                  )}
                ...
                <Tab className="outline-none">
                  {({ selected }) => (
                    <div
                      className={`${
                        selected
                          ? "border-b-2 border-[#36FFE8] text-[#36FFE8]"
                          : "text-[#EAECF0] border-transparent"
                      } text-sm px-4 pb-2 ease transition-all`}
                    >
                      Tips & supporters
                    </div>
                  )}
              ...
              <Tab.Panels>
                <Tab.Panel>
                  <EpisodeLiveView
                    episodes={episodes}
                    isArchive={isArchive}
                    view={params.podcastId[1] == "card" ? "card" : "list"}  

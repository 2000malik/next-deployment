...
import { authLogin, resetAuth } from "@/src/Redux/Auth";
import { PublishersCategory } from "@/src/Models/publishers-category";
import PasswordInput from "@/src/Components/password-input";
import { getPublisherCategories } from "../../api/General";
    ...
    <div className="flex-1">
      <div className="">
        <div className="flex min-h-screen">
          <div className="md:w-6/12 w-full bg-dark contianer md:px-8 py-8 max-h-screen overflow-auto">
            ...
            <div className="mt-24 text-left">
              <div className="md:w-9/12 mx-auto md:px-0 px-6">
                <div className="flex-1">
                  <div className="text-gray-50 text-3xl font-bold font-raleway">
                    Sign up
                  </div>
                  <div className="text-gray-100 mt-2">
                    Create a free account today and start creating amazing
                    podcasts.
                  </div>
                </div>
                <Formik
                        ...
                        <div className="space-y-5">
                          ...
                          <div className="">
                            <div className="flex-1">
                              ...
                              >
                                ...
                                <Link href="/" className=" text-[#25AEA4]">
                                  {" "}
                                  Terms & Conditions{" "}
                                </Link>{" "}
                                and{" "}
                          ...
                          <div className="space-y-4">
                            ...
                            <Button
                              ...
                              className="w-full !bg-white from-white to-white"
                            >
                          ...
                          <div className="text-center">
                            <div className="text-sm font-normal text-gray-50">
                              ...
                              <Link
                                href="/login"
                                className="font-semibold text-base text-cyan-200 font-inter"
                              >
                                {" "}
                                Log in
                              </Link>
          ...
          >
            <div className="">
              <div className="self text-gray-50 text-[64px] font-extrabold font-raleway leading-tight">
                Join Wokpa Podcast Platform
              </div>
              <div className="w-[558px] text-gray-100 text-[20px] font-normal leading-normal">
                Embark on your podcasting journey. Register with Wokpa and
                unlock a suite of tools and features to bring your podcast to
                life.
              </div>
            </div>
          </div>

              ...
              <div className="w-[38%]">
                <div className="bg-[#141414] p-8 space-y-4 rounded-xl text-center">
                  ...
                  <div className="text-sm ">
                    Your registration has been successful. Kindly press the
                    button below to redirect to your dashboard.
                  </div>
                  <div className="mt-8 text-sm font-semibold ">
                    <Link
                      href="/dashboard"
                      className="rounded-[40px] py-3 px-5 bg-gradient-to-r from-[#083F62] to-[#25AEA4] text-white font-medium  inline-block w-full"
                    >
                      Go to dashboard
                    </Link>
                  </div>

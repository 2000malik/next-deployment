...
import { authLogin, resetAuth, updateProfile } from "@/src/Redux/Auth";
import { APICall } from "@/src/Utils";
import { getProfile, googleLogin, login } from "../../api/Auth";
                          ...
                          <div className="flex justify-between">
                            ...
                            <div>
                              <Link
                                ...
                                className="text-sm font-slate-300"
                              >
                                Forgot password
                              </Link>
                            </div>
          ...
          >
            <div className="">
              <div className="self text-gray-50 text-[64px] font-extrabold font-raleway leading-tight">
                Welcome to Wokpa Podcast Platform
              </div>
              <div className="w-[558px] text-gray-100 text-[20px] font-normal leading-normal">
                Unlock the power of podcasting. Log in to Wokpa and access a
                world of possibilities tailored to your podcasting journey.
              </div>
            </div>
          </div>
        </div>

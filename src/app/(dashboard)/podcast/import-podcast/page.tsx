...
import { importPodcast, initiatePodcastImport } from "@/src/app/api/publishers";
  ...
  return (
    <div id="dashboard">
      <Modal
        size="md"
        open={showOtpModal}
        onClose={(val) => setShowOtpModal(val)}
      >
        ...
        <div className="py-10 text-center">
          ...
          <div>
            ...
            <div className="mt-2">
              <OtpInput
                ...
                inputStyle={
                  "border border-slate-600 outline-none text-6xl mx-1 !w-14 h-12 md:!w-20 md:h-[4.6rem] disabled:opacity-70 rounded-lg font-inter text-slate-600"
                }
                renderInput={(props) => (
                  <input
                    {...props}
              ...
              {timer !== 0 ? (
                ...
                <div
                  ...
                  className="text-blue-600 underline cursor-pointe mt-4 cursor-pointer"
                >
                  resend to email
                </div>
              )}
          ...
          <div className="mt-8">
            <Button
              ...
              className="!text-sm !py-[0.63rem] text-center disabled:opacity-80 disabled:cursor-not-allowed"
            >
              {loading ? (
                <svg
      ...
      <div className="mt-8">
        <div className="pr-5">
          ...
          <div className="mt-2">
            <div className="text-sm">
              Importing your podcast from existing feed is the easiest and
              fastest way to copy your podcasts and <br /> migrate to our
              platform.
            </div>
          </div>
        </div>
        <div className="mt-8">
          ...
          <div className="mt-2">
            <div className="">
              Copy a link from your original website and paste it below. We
              support RSS feeds <br /> containing mp3, mp4, m4a, wav, 3gp ,aac,
              amr, flac, ogg, ra, wma, asf files.
            </div>
          </div>
          <div className="mt-6">
            <div className="md:w-6/12">
              <input
                ...
                type="text"
                name="link"
                placeholder="Paste here link of your rss feed"

...
import { getPodcastCategories } from "@/src/app/api/General";
import { PodcastCategoryModel } from "@/src/Models/category";
...
const UpdatePodcastPage = ({ params }: { params: { podcastId: string[] } }) => {
  ...
  const [
    coverImagePicker,
    {
      filesContent: coverImageContent,
      plainFiles: coverImageFiles,
    ...
    try {
      ...
      const data = {
        ...
        category_name: categories.find(
          (val) => val.id == values.podcast_category
        )?.name,
    ...
    (async () => {
      try {
        ...
        if (params.podcastId.length) {
          setIsEdit(true);
          response = params.podcastId[1]
            ? await getArchivePodcastsById(params.podcastId[0])
            : await getPodcastsById(params.podcastId[0]);
                    ...
                    <div className="space-y-8">
                          ...
                          <div className="w-[348px] py-4">
                            <div className="text-center">
                              ...
                              <div className="text-xs text-[#EAECF0] px-6">
                                We recommend uploading an artwork of at least
                                1400x1400 pixels and maximum 5MB. We support
                                jpg, png, gif and tiff formats.
                              </div>
                              <div className="mt-4">
                                <button
                                  type="button"
                                  onClick={() => imagePicker()}
                                  className="bg-[#F9F5FF] rounded-full py-2 px-4 text-sm font-semibold text-[#042946]"
                                >
                                  Upload image
                                </button>
                              </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="w-[348px] py-4">
                            <div className="text-center">
                              ...
                              <div className="text-xs text-[#EAECF0] px-6">
                                Adding a cover image is a great way to enhance
                                your podcast page. Become a Pro user to upload
                                one now.
                              </div>
                              <div className="mt-4">
                                <button
                                  type="button"
                                  onClick={() => coverImagePicker()}
                                  className="bg-[#F9F5FF] rounded-full py-2 px-4 text-sm font-semibold text-[#042946]"
                                >
                                  Upload image
                                </button>
                      ...
                      <div className="flex gap-5">
                        <div className="md:w-6/12">
                          ...
                          <div className="text-xs text-[#D0D5DD] mt-1">
                            Listeners want to know what your podcast is about
                            before they tune in. Hook them in with a persuasive
                            description that quickly sums up what the main
                            concept and structure of your podcast is.
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-5">
                        <div className="md:w-6/12">
                          ...
                          <div className="flex items-center gap-2">
                            <Switch
                              ...
                              className={`${
                                enableTips ? "bg-[#21A79C]" : "bg-slate-600"
                      ...
                      <div className="flex">
                        <div className="md:w-6/12">
                          ...
                          />
                          <div className="text-xs text-[#D0D5DD] mt-1">
                            By adding your email address here, it will be
                            displayed on your podcast page and RSS feed. This
                            email address allows you to confirm the ownership
                            into platforms like Spotify and Google Podcasts.
                          </div>
                        </div>
                      </div>
                      <div className="flex">
                        ...
                        <div className="md:w-6/12">
                          ...
                          <div className="flex items-center gap-2">
                            <Switch
                              ...
                              className={`${
                                isExplicit ? "bg-[#21A79C]" : "bg-slate-600"
                              } relative inline-flex h-[18px] w-[32px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                            >
                              <span className="sr-only">Use setting</span>
                              <span

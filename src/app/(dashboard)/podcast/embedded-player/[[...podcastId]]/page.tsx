    ...
    <div id="dashboard">
      <div className="relative">
        <div className="flex gap-3 items-center">
          <div className="text-sm font-medium">All Podcasts</div>
          <div>
            <svg
              width="16"
              height="16"
          ...
          <div className="text-sm font-medium">Emax podcast</div>
          <div>
            <svg
              width="16"
              height="16"
          ...
          <div className="text-sm font-medium text-[#66C6BF]">Episodes</div>
        </div>
      </div>
      <div className="mt-8">
        <div className="pr-5">
                ...
                <div className="mt-4">
                  <div className="flex w-7/12 items-center gap-8">
                    <div className="flex-1">
                      <input
                        placeholder="https://www.wokpa.com/emax-podcast"
                        type="text"
                    ...
                    <div>
                      <button className="bg-white inline-flex items-center gap-2 rounded-full py-2 px-3">
                        ...
                        <span className="text-sm !text-[#063150] font-semibold">
                          Copy
                        </span>
                      </button>
                    </div>

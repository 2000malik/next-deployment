    ...
    <div className="text-center">
      ...
      <div className="text-center space-x-1">
        <button>
          ...
          >
            <g clip-path="url(#clip0_4782_16052)">
              <path
                d="M9.99967 6.26634V3.33301C9.99967 2.22844 9.10424 1.33301 7.99967 1.33301C7.2146 1.33301 6.53517 1.78535 6.20781 2.44363M7.99967 12.6663V14.6663M7.99967 12.6663C5.42235 12.6663 3.33301 10.577 3.33301 7.99967V6.66634M7.99967 12.6663C10.577 12.6663 12.6663 10.577 12.6663 7.99967V6.66634M5.33301 14.6663H10.6663M1.33301 1.33301L14.6663 14.6663M7.99967 9.99967C6.89511 9.99967 5.99967 9.10424 5.99967 7.99967V5.99967L9.41474 9.41303C9.05275 9.77546 8.55239 9.99967 7.99967 9.99967Z"
                stroke="#EAECF0"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <button>
          ...
          >
            <path
              d="M3.99967 12.6667C3.99967 13.4 4.59967 14 5.33301 14H10.6663C11.3997 14 11.9997 13.4 11.9997 12.6667V4.66667H3.99967V12.6667ZM5.33301 6H10.6663V12.6667H5.33301V6ZM10.333 2.66667L9.66634 2H6.33301L5.66634 2.66667H3.33301V4H12.6663V2.66667H10.333Z"
              fill="#F04438"
            />
          </svg>
        </button>
        ...
        <div className="flex justify-between items-center gap-6  border-b border-[#344054]">
          <div className="flex justify-between">
            <div className="border-r border-[#344054] py-6">
              <button
                id={BUTTON_ID}
                className="inline-flex gap-6 items-center pr-12"
              >
                <svg
                  width="40"
                  height="40"
        ...
        <div className="mt-8 flex gap-10">
          ...
          <div className="space-y-6 w-[28%]">
            ...
            <div className=" bg-dark rounded-lg">
              ...
              <div className="mt-4">
                <div className="grid grid-cols-3 gap-x-2 gap-y-4 px-4 pb-64"></div>
              </div>
            </div>
          </div>
        </div>

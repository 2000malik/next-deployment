...
import { getPodcasts, uploadEpisode } from "@/src/app/api/publishers";
              ...
              <div>
                ...
                <div className="w-8/12">
                  <div
                    {...getRootProps({
                      className:
                        "dropzone border-2 rounded-lg bg-grayTrue border-[#98A2B3] p-10 text-center border-dashed",
                    })}
                  >
                    <input {...getInputProps()} />
                    {audioFile

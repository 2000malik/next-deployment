...
import { getArchivePodcastsById, getPodcastRssById, getPodcastsById } from "@/app/api/publishers";
...
const DistributionPage = ({ params }: { params: { podcastId: string[] } }) => {
    ...
    const handletGetRSSUrl = async () => {
        try {
            const response = await APICall(getPodcastRssById, params?.podcastId[0])
            setFeedUrl(response?.data?.data?.feed_url)
            // console.log(response?.data?.data?.feed_url)
        } catch (err) {
            console.log(err)
        }
    }
        ...
        <div id="dashboard">
            <div className="relative">
                <div className="flex gap-3 items-center">
                    ...
                    <div className="text-sm font-medium">
                        {podcast ? (
                            <Link href={`/podcast/podcast-view/${podcast?.id}`}>
                                {podcast?.title}
                            </Link>
                        ) : (
                            <div className="h-2 w-32 bg-gray-100 animate-pulse rounded"></div>
                        )}
                    </div>
                    <div>
                        <svg
                    ...
                    <div className="text-sm font-medium text-[#66C6BF]">Distribution</div>
                </div>
            </div>
            <div className="mt-8">
                <div className="pr-5">
                    <div className={`font-semibold text-xl pb-2`}>Distribution</div>
                    <div>
                        <p className="text-sm">
                            Find new listeners by distributing your podcast to all the major
                            listening platforms. You'll be able to measure the results from
                            the Statistics page and monetize your podcast whenever it’s
                            listened to.
                        </p>
                    </div>
                </div>
                <div className="mt-8 space-y-4">
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                            ...
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Apple podcast</div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                <div className="pr-6">
                                    Thousands of podcasts are distributed by Apple podcast, one of
                                    the most downloaded apps and used websites in the US for
                                    podcast listening.
                                </div>
                                <Link href="https://podcastsconnect.apple.com/login?targetUrl=%2F&authResult=FAILED" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    </Disclosure>
                            ...
                            <div>
                                ...
                                <div className="mt-4">
                                    <div className="flex w-7/12 items-center gap-8">
                                        <div className="flex-1">
                                            <input
                                                placeholder={feedUrl}
                                                type="text"
                                                className="w-full py-3 px-4 rounded-lg bg-[#202939] text-[#F2F4F7] placeholder:text-[#F2F4F7] border-0"
                                            />
                                        </div>
                                        <div>
                                            <button className="bg-white inline-flex items-center gap-2 rounded-full py-2 px-3">
                                                ...
                                                <span onClick={() => copyToClipboard(feedUrl)} className="text-sm !text-[#063150] font-semibold">
                                                    Copy
                                                </span>
                                            </button>
                                        </div>
                                    ...
                                    <div className="mt-4 text-sm text-[#F9FAFB]">
                                        This is the URL of your podcast on Wokpa. Share it to get
                                        more listeners!
                                    </div>
                                </div>
                            </div>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                            ...
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <div className="text-sm mt-2">Distribute to Spotify</div>
                                    </div>
                                </div>
                                <div>
                                    <svg
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                <div className="pr-6">
                                    The most popular app for consuming audio content, offering
                                    podcasters the opportunity to be listened to by millions of
                                    people in over 60 markets.
                                </div>
                                <Link href="https://podcasters.spotify.com/submit" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                                ...
                                <div className="flex items-center gap-4">
                                    <div>
                                        <Image
                                            width={50}
                                            alt="goolePods"
                                            className=" self-end justify-end mr-3 ml-2"
                                            src={googlePodsPng}
                                        />
                                    </div>
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Google podcast</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Google Pods
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://pubsubhubbub.appspot.com/publish" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Audiomack</div>
                                        <div className="text-sm mt-2">
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://audiomack.com/" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Jiosaavn</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Jiosaavn
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://yourcast.jiosaavn.com/register" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                                ...
                                <div className="flex items-center gap-4">
                                    <div>
                                        <Image
                                            width={70}
                                            alt="goolePods"
                                            className=" self-end justify-end ml-1"
                                            src={deezerPodsPng}
                                        />
                                    </div>
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Deezer</div>
                                        <div className="text-sm mt-2">
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://podcasters.deezer.com/" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="text-lg font-bold">iHeart</div>
                                        <div className="text-sm mt-2">
                                            Distribute to iHeart
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link target="_blank" href="https://podcasters.iheart.com/#submit-podcast" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                            ...
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left -ml-6">
                                        <div className="text-lg font-bold">Castbox</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Castbox
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://castbox.fm/podcasters-tools/" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                            ...
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left -ml-10">
                                        <div className="text-lg font-bold">Goodpods</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Good Pods
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://goodpods.com/for-podcasters" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left -ml-6">
                                        <div className="text-lg font-bold">Boomplay</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Boomplay
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://www.boomplay.com/" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left -ml-6">
                                        <div className="text-lg font-bold">Podchaser</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Podcahser
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://www.podchaser.com/" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Amazon Podcast</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Amazon podcast
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://podcasters.amazon.com/submit-rss" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>
                    ...
                    <Disclosure as="div" className="bg-[#141414] rounded-xl">
                        <Disclosure.Button className="w-full">
                            <div className="flex justify-between items-center px-6 py-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        <div className="text-lg font-bold">Podcast Addicts</div>
                                        <div className="text-sm mt-2">
                                            Distribute to Podcast Addicts
                                        </div>
                                    </div>
                                </div>
                                <div>
                        ...
                        <Disclosure.Panel className="border-t px-6 py-6">
                            <div>
                                ...
                                <Link href="https://podcastaddict.com/submit" target="_blank" className="mt-4">
                                    <Button className="py-2 mt-4">Submit</Button>
                                </Link>
                            </div>
                        </Disclosure.Panel>

...
import { getArchivePodcastsById,
  getPodcastRssById,
  getPodcastsById, } from "@/src/app/api/publishers";
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://podcastsconnect.apple.com/login?targetUrl=%2F&authResult=FAILED"
                  target="_blank"
                  className="mt-4"
                >
                    ...
                    <div>
                      <button className="bg-white inline-flex items-center gap-2 rounded-full py-2 px-3">
                        ...
                        <span
                          ...
                          className="text-sm !text-[#063150] font-semibold"
                        >
                          Copy
                        </span>
                      </button>
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://pubsubhubbub.appspot.com/publish"
                  target="_blank"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm mt-2">Distribute to Audiomack</div>
                  </div>
                </div>
                <div>
                  <svg
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm mt-2">Distribute to Jiosaavn</div>
                  </div>
                </div>
                <div>
                  <svg
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://yourcast.jiosaavn.com/register"
                  target="_blank"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm mt-2">Distribute to Deezer</div>
                  </div>
                </div>
                <div>
                  <svg
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm mt-2">Distribute to iHeart</div>
                  </div>
                </div>
                <div>
                  <svg
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  target="_blank"
                  href="https://podcasters.iheart.com/#submit-podcast"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>
                </Link>
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left -ml-6">
                    ...
                    <div className="text-sm mt-2">Distribute to Castbox</div>
                  </div>
                </div>
                <div>
                  <svg
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://castbox.fm/podcasters-tools/"
                  target="_blank"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left -ml-10">
                    ...
                    <div className="text-sm mt-2">Distribute to Good Pods</div>
                  </div>
                </div>
                <div>
                  <svg
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://goodpods.com/for-podcasters"
                  target="_blank"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left -ml-6">
                    ...
                    <div className="text-sm mt-2">Distribute to Boomplay</div>
                  </div>
                </div>
                <div>
                  <svg
              ...
              <div className="flex justify-between items-center px-6 py-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left -ml-6">
                    ...
                    <div className="text-sm mt-2">Distribute to Podcahser</div>
                  </div>
                </div>
                <div>
                  <svg
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://podcasters.amazon.com/submit-rss"
                  target="_blank"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>
          ...
          <Disclosure as="div" className="bg-[#141414] rounded-xl">
            ...
            <Disclosure.Panel className="border-t px-6 py-6">
              <div>
                ...
                <Link
                  href="https://podcastaddict.com/submit"
                  target="_blank"
                  className="mt-4"
                >
                  <Button className="py-2 mt-4">Submit</Button>

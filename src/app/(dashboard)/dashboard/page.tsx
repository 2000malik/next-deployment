...
import {
  ...
  getPodcastArchive,
  getPodcasts,
  removeArchivePodcasts,
} from "../../api/publishers";
import { pushPodcasts, refreshPodcasts } from "@/src/Redux/podcast";
...
const GetPaidCard = () => {
  return (
    <div
      className="relative flex-1 rounded-3xl px-6 py-10"
      style={{ background: "linear-gradient(45deg, #083F62 0%, #25AEA4 100%)" }}
    >
      ...
      <div className="flex items-center gap-4 justify-center">
        ...
        <div className="flex-1">
          ...
          <div>
            <span className="">
              Welcome to Wokpa. Do well to enjoy all our awesome features and
              start creating!!
            </span>
          </div>
        </div>
...
const AnalyticsCard = () => {
  return (
    <div
      className="relative flex-1 rounded-3xl px-6 py-10"
      style={{ background: "linear-gradient(27deg, #383C9E 0%, #6941C6 100%)" }}
    >
      <div className="absolute top-0 right-0 flex justify-end">
        <div className=" p-4">
          <button>
      ...
      <div className="flex items-center gap-1 justify-center">
        ...
        <div className="flex-1">
          ...
          <div>
            <span className="">
              Unlock podcast analytics with Wokpa's powerful cards and elevate
              your content.
            </span>
          </div>
        </div>
...
const PodcastItem: React.FC<{
  ...
  isArchive: boolean;
}> = ({ mode, podcast, isArchive }) => {
  const navigate = useRouter();
  const [loading, setLoading] = useState(false);
  const [selectedPodcast, setSelectedPodcast] = useState<PodcastModel | null>(
    null
  );
        ...
        <div className="w-full flex justify-between items-center py-6">
          <div className="flex gap-4">
            <Link
              ...
              href={
                isArchive
                  ? `/podcast/podcast-view/${podcast.id}/archive`
                  : `/podcast/podcast-view/${podcast.id}`
              }
            >
              <img
          ...
          <div className="flex gap-4">
            <div className="text-center">
              <Link
                href={
                  isArchive
                    ? `/podcast/edit-podcast/${podcast.id}/archive`
                    : `/podcast/edit-podcast/${podcast.id}`
                }
              >
                <div>
                  <svg
              ...
              <Popover as={"div"} className="relative">
                <Popover.Button ref={setReferenceElement} className="">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M18 14C18 15.1 18.9 16 20 16C21.1 16 22 15.1 22 14C22 12.9 21.1 12 20 12C18.9 12 18 12.9 18 14ZM16 14C16 12.9 15.1 12 14 12C12.9 12 12 12.9 12 14C12 15.1 12.9 16 14 16C15.1 16 16 15.1 16 14ZM10 14C10 12.9 9.1 12 8 12C6.9 12 6 12.9 6 14C6 15.1 6.9 16 8 16C9.1 16 10 15.1 10 14Z"
                      fill="#344054"
                    />
                  </svg>
                </Popover.Button>
...
const PodcastTable = () => {
  ...
  const handleGetPodcast = async (page?: number, title = "") => {
    try {
      setSearch(title);
      const response = await APICall(
        isArchive ? getPodcastArchive : getPodcasts,
                  ...
                  <Button
                    onClick={() => {
                      isArchive
                        ...
                        : navigate.push("/podcast/create-podcast");
                    }}
                    className="text-sm"
                  >
    ...
    <div id="dashboard">
      <div className="">
        <div className="flex justify-end gap-2">
          <div>
            <Button
              onClick={() => navigate.push("/podcast/import-podcast")}
              className="!from-white !to-white !text-[#063150] text-sm font-semibold"
            >
              Import new podcast
            </Button>
          </div>
          <div>
            <Button
              onClick={() => navigate.push("/podcast/create-podcast")}

...
const TimeListenedChart = () => {
  return (
    <div className="">
      <div className="text-sm">Time listened</div>
      {/* total income */}
      ...
      <div className="py-6 px-6 rounded-xl mt-3 bg-white space-y-10">
        <div className="flex gap-4 py-1">
          <div className="flex-1">
            <div className="text-3xl font-raleway font-medium text-[#101828]">
              2k
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex gap-1 items-center">
              ...
              >
                <path
                  d="M18.3332 5.83203L11.776 12.3892C11.446 12.7192 11.281 12.8842 11.0907 12.9461C10.9233 13.0004 10.743 13.0004 10.5757 12.9461C10.3854 12.8842 10.2204 12.7192 9.89036 12.3892L7.60931 10.1082C7.2793 9.77816 7.11429 9.61315 6.92402 9.55133C6.75665 9.49695 6.57636 9.49695 6.40899 9.55133C6.21872 9.61315 6.05371 9.77816 5.72369 10.1082L1.6665 14.1654M18.3332 5.83203H12.4998M18.3332 5.83203V11.6654"
                  stroke="#17B26A"
                  stroke-width="2"
            ...
            <span className="text-sm text-[#1D2939]">vs last month</span>
          </div>
        </div>
  ...
  return (
    <div className="">
      <div className="text-sm font-medium">
        ...
        <span className="text-xs text-[#98A2B3]">Streams</span>
      </div>
      ...
      <div className="py-6 px-6 rounded-xl mt-3 bg-white space-y-10 ">
        ...
        <div className="">
          <ResponsiveContainer width="100%" height={170}>
            <BarChart width={500} height={170} data={ageData}>
              <XAxis dataKey="name" />
              <YAxis />
...
const RecentEpisodes = () => {
  ...
  return (
    <div className="">
      <div className="text-sm">Recent Episodes</div>
      {
        <div className="mt-3">
          {
            <div>
                ...
                <table className="border-collapse table-auto w-full whitespace-nowrap">
                  <thead className="text-white text-left border-b-2 border-[#EAECF0]">
                    <tr>
                      ...
                      <th className="py-4 pl-6 font-medium text-sm text-right">
                        Date uploaded
                      </th>
                      <th className="py-4 pl-6 font-medium text-sm text-right">
                        Duration
                  ...
                  <tbody className="">
                    {episodes.map((episode) => {
                      return (
                        <tr className="hover:bg-grayTrue cursor-pointer">
                          ...
                          <td className="py-4 border-b pl-6 text-xs border-t border-[#667085] text-right">
                            <div className="">
                              {moment(episode.created_at).format(
                                "MMM YYYY, DD"
                              )}
                            </div>
                          </td>
                          ...
                          <td className="py-4 border-b px-6 text-xs border-t border-[#667085] text-right">
                            <div className="">{episode.play_count}</div>
                          </td>
                        </tr>
                      );
                    })}
...
const PodcastView = ({ params }: { params: { podcastId: string } }) => {
  ...
  const handleGetEpisodes = async (page?: number) => {
    try {
      console.log(page);
      const response = await APICall(
        isArchive ? getEpisodesArchive : getPodcastEpisodes,
        [params.podcastId, page ? page : currentPage, 15]
      );
      setEpidoes(response.data.data.data);
      setTotalContent(response.data.data.total);
    } catch (error) {
      ...
      <div className="relative">
        ...
        <div className="border rounded-lg p-2 flex items-center gap-8 mt-6">
          <div className="!w-[100px] !h-[100px]">
            <img
              className="!w-[100px] !h-[100px] rounded-lg border-2 border-[#BEE7E4] object-cover"
              src={podcast?.picture_url}
              alt=""
            />
          </div>
          <div className="mt-2">
            <div className="text-xl font-bold">{podcast?.title}</div>
            <div className="text-sm font-medium mt-2">By: {podcast?.title}</div>
            ...
            <div className="flex gap-8">
              ...
              <button>
                ...
                >
                  ...
                  <path
                    d="M29 23V24.2C29 25.8802 29 26.7202 28.673 27.362C28.3854 27.9265 27.9265 28.3854 27.362 28.673C26.7202 29 25.8802 29 24.2 29H15.8C14.1198 29 13.2798 29 12.638 28.673C12.0735 28.3854 11.6146 27.9265 11.327 27.362C11 26.7202 11 25.8802 11 24.2V23M25 18L20 23M20 23L15 18M20 23V11"
                    stroke="#EAECF0"
                    stroke-width="2"
                    stroke-linecap="round"
                    strokeLinejoin="round"
                  ...
                  <div className="grid grid-cols-4 gap-8  ">
                    ...
                    <div className="py-6 px-6 rounded-xl bg-grayTrue space-y-2">
                      <div className="flex gap-6">
                        ...
                        >
                          <g clip-path="url(#clip0_5552_61211)">
                            <path
                              d="M9.99984 13.3346V10.0013M9.99984 6.66797H10.0082M18.3332 10.0013C18.3332 14.6037 14.6022 18.3346 9.99984 18.3346C5.39746 18.3346 1.6665 14.6037 1.6665 10.0013C1.6665 5.39893 5.39746 1.66797 9.99984 1.66797C14.6022 1.66797 18.3332 5.39893 18.3332 10.0013Z"
                              stroke="#D0D5DD"
                              stroke-width="2"
                              stroke-linecap="round"
                              strokeLinejoin="round"
                      ...
                      <div className="flex items-center">
                        ...
                        >
                          <path
                            d="M7 20V5H7.5L16.5 19H17V4M4 10H20M4 14H20"
                            stroke="#F9FAFB"
                            stroke-width="2"
                          />
                        </svg>

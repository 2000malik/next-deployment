    ...
    <div id="dashboard">
      <div className="relative">
        <div className="flex gap-3 items-center">
          ...
          <div className="text-sm font-medium text-[#66C6BF]">Campaign</div>
        </div>
        <div className="pr-5 mt-8">
          <div className={`font-semibold text-xl pb-2`}>Campaigns</div>
          <div>
            <p className="text-sm">
      ...
      <div className="mt-8">
        <div className="">
          <div className="space-y-5">
            ...
            <div>
              <div>
                <Button className="text-sm font-semibold">Visit portal</Button>
              </div>
            </div>
          </div>
        </div>

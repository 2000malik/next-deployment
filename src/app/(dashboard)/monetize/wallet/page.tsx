...
import { VirtualAccountModel } from "@/src/Models/virtual-account";
...
const WalletPage = () => {
  ...
  const [virtualAccount, setVirtualAccount] =
    useState<VirtualAccountModel | null>(null);
  ...
  return (
    <div id="dashboard">
      <Modal
        ...
        onClose={(val) => setShowAccountModal(val)}
      >
      ...
      <Modal
        ...
        onClose={(val) => setShowTransferModal(val)}
      >
        <div className="border-b text-center text-2xl font-raleway font-bold py-5">
          Send money
        </div>
      ...
      <Modal
        ...
        onClose={(val) => setEditShowAccountModal(val)}
      >
        <div className="border-b text-center text-2xl font-raleway font-bold py-5">
          {!kyc ? "Create" : "Edit"} KYC
        </div>
              ...
              <div className="py-10 text-center">
                <div className="px-8">
                  ...
                  <div className="space-y-4 mt-6">
                    ...
                    <div className="mt-4">
                      <div className="font-medium text-left">Utility bill</div>
                      <div className="py-4">
                        <div
                          {...getUtilityRootProps({
                            className:
                              "dropzone border-2 rounded-lg bg-dark border-[#98A2B3] px-10 py-2 text-center",
                          })}
                        >
                          ...
                          {idFile ? (
                            ...
                            <div className="text-center space-y-4">
                              ...
                              <div className="text-xs">
                                <span className="font-semibold text-[#36FFE8] text-sm">
                                  Click to upload
                                </span>{" "}
                                or drag and drop
                              </div>
                ...
                <div className="mt-8 space-y-4 px-8">
                  <div className="text-right space-x-4">
                    <Button
                      type="button"
                      onClick={() => setEditShowAccountModal(false)}
                      className="from-white !to-white !text-[#063150] font-semibold !py-[0.63rem] text-center"
                    >
                      Cancel
                    </Button>
      ...
      <div className="relative">
        <div className="flex gap-3 items-center">
          ...
          <div className="text-sm font-medium">Monitize</div>
          <div>
            <svg
              width="16"
              height="16"
          ...
          <div className="text-sm font-medium text-[#66C6BF]">Wallet</div>
        </div>
        <div className="pr-5 mt-5">
          <div className={`font-semibold text-xl pb-2`}>Wallet</div>
          <div>
            <p className="text-sm">
        ...
        <div className="flex justify-between mt-4">
          <div className="text-lg font-semibold self-end">Total balance</div>
          <div className="flex justify-end gap-2 mt-4">
            <div>
              <Button
                ...
                className="!from-transparent !to-transparent text-sm font-semibold border bg-gradient-to-r bg-clip-text"
              >
                {!kyc ? "Create KYC" : "Edit KYC"}
              </Button>
            </div>
            <div>
              <Button
        ...
        <div className="mt-4">
          <div className="flex gap-4">
            <div className="font-raleway text-4xl font-bold flex items-center">
              <span className="font-semibolduso mr-1">₦</span>
              {virtualAccount
                ? formatToCurrency(virtualAccount.available_balance / 100)
                : "0.00"}
            </div>
      ...
      <div className="mt-8">
        <div className="grid grid-cols-3 gap-4">
          <div className="py-4 px-6 rounded-xl bg-grayTrue border border-zinc-600">
            <div className="flex gap-4">
              <svg
                width="24"
                height="24"
              ...
              <div>
                ...
                <div className="mt-4 flex gap-4 items-center">
                  ...
                  {/* TODO: fix text type issue */}
                  <CopyToClipboard
                    // text={virtualAccount?.number}
                    text="in progress"
                    onCopy={() =>
                      toast("Account number copied!", { type: "success" })
                    }
                  >
                    <button>
                      <svg
      ...
      <div className="mt-8">
        <div className="flex justify-between">
          <div className="font-semibold text-lg">Most recent transactions</div>
          <Link
            href="/monitize/payment-history"
            className="text-sm font-semibold text-[#4FFFEB]"
          >

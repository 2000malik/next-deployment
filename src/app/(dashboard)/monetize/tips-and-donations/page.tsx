      ...
      <div className="py-6 px-6 rounded-xl mt-3 space-y-10 ">
        ...
        <div className="">
          <ResponsiveContainer width="100%" height={180}>
            <BarChart width={500} height={170} data={data}>
              <XAxis
                fill="#F2F4F7"
                className="font-inter text-xs text-[#F2F4F7]"
                axisLine={false}
                tickLine={false}
                dataKey="name"
              />
                  ...
                  return (
                    <tr>
                      <td className="py-4 border-b pl-10 text-xs font-medium border-t border-[#667085]">
                        <div className="">
                          <input
                            className="rounded-md border-[#D0D5DD] bg-white"
                            type="checkbox"
                            name=""
                            id=""
                          />
    ...
    <div id="dashboard">
      <div className="relative">
        <div className="flex gap-3 items-center">
          ...
          <div className="text-sm font-medium">
            <Link href="/monetize/wallet">Monetize</Link>
          </div>
          <div>
            <svg
              width="16"
        ...
        <div className="pr-5 mt-5">
          <div className={`font-semibold text-xl pb-2`}>Tips and donations</div>
          <div>
            <p className="text-sm">
              Your revenue will grow along with your audience and it's all
              automatic with direct tips and donations from your listeners.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="flex items-center gap-2 py-2">
          <Switch
            ...
            onChange={() => {}}
            className={`${
              true ? "bg-[#21A79C]" : "bg-teal-700"
            } relative inline-flex h-[18px] w-[32px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
          >
            <span className="sr-only">Use setting</span>
            <span
              aria-hidden="true"
              className={`${
                true ? "translate-x-[0.82rem]" : "translate-x-0"
              } pointer-events-none inline-block h-[16px] w-[16px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
            />
          </Switch>
          <div className="text-sm font-medium">Activate tips and donations</div>
        </div>
      </div>
      ...
      <div className="mt-8">
        <div className="py-6 px-6 rounded-xl bg-grayTrue">
          <div className="flex justify-between">
            <div className="text-lg font-medium">Tips and donation stats</div>
            <div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="text-sm font-medium text-[#344054]">
                    Last 30 days revenue in cash
                  </div>
                </div>
              </div>
              <div className="mt-4 flex justify-between font-">
                <div className="text-2xl font-bold font-raleway text-[#101828]">
                  <span className="font-bold">₦</span> 4,000
                </div>
        ...
        <div>
          <div className="my-4">
            <div className="font-medium">Tips and donations history</div>
          </div>
          <div>
            <div className="overflow-x-auto mt-4 md:h-auto h-96 rounded-lg">
              <table className="border-collapse table-auto w-full whitespace-nowrap">
                <thead className="ext-left border-none">
                  <tr>
                    <th className="py-4 pl-10 font-medium text-lg">
                      Name of user
                    </th>
                    <th className="py-4 pl-6 font-medium text-lg">
                      Episode title
                    </th>
                    ...
                    return (
                      <tr>
                        ...
                        <td className="py-3 pl-6  font-medium border-b-4 border-dark bg-[#141414] text-sm">
                          <div className="">Episode title 1 sample</div>
                        </td>
                        <td className="py-3 pl-6  font-medium border-b-4 border-dark bg-[#141414] text-sm">
                        ...
                        <td className="py-3 pl-6  font-medium border-b-4 border-dark bg-[#141414] text-sm">
                          <div className="">06 May 2023, 9:00AM</div>
                        </td>
                      </tr>
                    );
                  })}
        ...
        <div>
          <div className="mt-8">
            <div className="font-medium">
              Activate your episodes to receive ads on it. Don't miss out on any

    ...
    <div id="dashboard">
      <div className="relative">
        <div className="flex gap-3 items-center">
          ...
          <div className="text-sm font-medium text-[#66C6BF]">Wokpa Ads</div>
        </div>
        <div className="pr-5 mt-5">
          <div className={`font-semibold text-xl pb-2`}>Wokpa Ads</div>
          <div>
            <p className="text-sm">
        ...
        <div className="py-4 px-6 rounded-xl bg-grayTrue">
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-2 py-2">
              ...
              <div className="text-sm font-medium">Ads exchange activation</div>
            </div>
            <div>
              <div>
      ...
      <div className="mt-8">
        <div className="py-6 px-6 rounded-xl bg-grayTrue">
          <div className="flex justify-between">
            <div className="text-lg font-medium">Ads exchange stats</div>
            <div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="py-6 px-6 rounded-xl bg-white">
              ...
              <div className="mt-4 flex justify-between font-">
                <div className="text-xl font-bold font-raleway text-[#101828]">
                  4,000
                </div>
            ...
            <div className="py-6 px-6 rounded-xl bg-white">
              ...
              <div className="mt-4 flex justify-between font-">
                <div className="text-xl font-bold font-raleway text-[#101828]">
                  <span className="font-medium">₦</span> 4,000
                </div>
                <span className="text-sm font-medium bg-green-100 py-1 px-3 rounded-full inline-flex items-center gap-1 font-inter text-green-600">
                  <svg
                    width="12"

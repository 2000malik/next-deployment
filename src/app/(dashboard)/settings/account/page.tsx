...
import { changePassword } from "@/src/app/api/Auth";
import { getProfile,getPublisherCategories } from "@/src/app/api/General";
import { udpateUserProfile } from "@/src/app/api/publishers";
import { PublishersCategory } from "@/src/Models/publishers-category";
...
const schema = Yup.object().shape({
  ...
  publisher_category: Yup.string().required("Publisher Category is required"),
  // password: Yup.string()
  ...
  terms: Yup.boolean().isTrue(
    "Accept Terms & Conditions to continue registration"
  ),
});
...
const ProfileSettings = () => {
  ...
  const [publishersCategory, setPublishersCategory] = useState<
    PublishersCategory[]
  >([]);
  ...
  return (
    <div id="dashboard">
      ...
      <div className="pr-5 mt-8">
        <div className={`font-bold text-xl pb-2`}>Account settings</div>
        <div>
          <p className="text-sm">
            Manage and update you profile pic and personal details. These will
            be displayed in your host profile page
          </p>
        </div>
      </div>
          ...
          <div className="flex gap-6">
            <div className="w-[130px] h-[130px] ob bg-slate-100 rounded-lg">
              <img
                ...
                src={profilePicImg || profile?.profile_image_url}
              />
            </div>
            <div>
              <div
                {...getRootProps({
                  className:
                    "h-full cursor-pointer dropzone border-2 rounded-lg bg-[#18181B] w-[358px] border-[#98A2B3] px-6 py-2 text-center",
                })}
              >
                <input {...getInputProps()} />
                {profilePicFile ? (
                ...
                <div className="mt-6">
                  <div className="space-y-5">
                    ...
                    <div className="space-x-4">
                      <Button
                        type="submit"
                        className="text-center font-semibold !py-[10px] !px-[18px]"
                      >
                        {isSubmitting ? (
                          <svg
        ...
        <div className="flex-1">
          <div className="bg-[#18181B] rounded-lg px-6 py-8">
            <div className="space-y-6">
              <div>
                <div className="text-sm">YOUR CURRENT PLAN</div>
      ...
      <div className="mt-8">
        <div className="pr-5 mt-8">
          <div className={`font-bold text-xl pb-2`}>Change Password</div>
          <div>
            <p className="text-sm">
              Manage and update you profile pic and personal details. These will
              be displayed in your host profile page

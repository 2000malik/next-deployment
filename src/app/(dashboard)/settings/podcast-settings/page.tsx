...
const PodcastSettingsPage = () => {
  ...
  return (
    <div id="dashboard">
      ...
      <div className="mt-8">
        <div className="pr-5">
          <div className={`font-bold text-xl pb-2`}>Podcast settings</div>
          <div>
            <p className="text-sm">
              Here you can customize the podcasts basic information as well as
              more advanced details such as the RSS Tags
            </p>
          </div>
        </div>
        <div className="mt-8">
            ...
            <div className="space-y-8">
                ...
                <div className="w-[348px] py-4">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-[#EAECF0] px-6">
                      ...
                      pixels and maximum 5MB. We support jpg, png, gif and tiff
                      formats.
                    </div>
                    <div className="mt-4">
              ...
              <div className="flex gap-5">
                <div className="md:w-6/12">
                  ...
                  />
                  <div className="text-xs text-[#D0D5DD] mt-1">
                    Listeners want to know what your podcast is about before
                    they tune in. Hook them in with a persuasive description
                    that quickly sums up what the main concept and structure of
                    your podcast is.
                  </div>
                </div>
              </div>
              ...
              <div className="flex">
                <div className="w-8/12">
                  ...
                  <div className="text-xs text-[#D0D5DD] mt-1">
                    By adding your email address here, it will be displayed on
                    your podcast page and RSS feed. This email address allows
                    you to confirm the ownership into platforms like Spotify and
                    Google Podcasts.
                  </div>
                </div>
              </div>

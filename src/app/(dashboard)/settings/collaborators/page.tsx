...
import { CollaboratorModel } from "@/src/Models/collaborators";
...
const CollaboratorsTable: React.FC<{
  ...
  update: () => void;
}> = ({ collaborators, onCreateCollaborator }) => {
  ...
  const [selectedCollaborator, setSelectedCollaborator] =
    useState<CollaboratorModel | null>(null);

  const [collaboratorField, setCollaboratorField] = useState<{
    name: string;
    email: string;
    role: string;
  }>({ name: "", email: "", role: "HOST" });
    ...
    <div className="mt-4">
      ...
      >
        ...
        <div className="py-10 text-center">
          <div className="px-6">
            <div className="flex gap-3 items-center">
              <div className="flex-1 text-left">
                ...
                <input
                  onChange={(e) =>
                    setCollaboratorField({
                      ...collaboratorField,
                      name: e.target.value,
                    })
                  }
                  value={collaboratorField.name}
                  name="name"
          ...
          <div className="mt-8 space-y-4 w-4/12 mx-auto"></div>
          <div className="mt-8 space-y-4 w-5/12 mx-auto">
            <div>
              <Button
                onClick={handleEditCollaborator}
                className="w-full !text-sm !py-[0.63rem] text-center"
              >
                {loading ? (
                  <svg
            ...
            <div>
              <Button
                ...
                className="w-full !from-white !to-white !text-[#063150] !py-[0.63rem] text-center"
              >
                Cancel
              </Button>
            </div>
      ...
      <Modal
        ...
        onClose={(val) => setShowDeleteModal(val)}
      >
                    ...
                    return (
                      <tr>
                          ...
                          <div className="">
                            ...
                            <div className="inline-flex items-center gap-2 ml-2">
                              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">
                                <div className="font-semibold text-[#475467]">
                        ...
                        <td className="py-4 border-b pl-6 text-xs border-t border-[#667085] ">
                          <div className="">{collaborator.role}</div>
                        </td>
...
const CollaboratorsPage = () => {
  ...
  const [collaboratorsField, setCollaboratorsField] = useState<
  ...
  return (
    <div id="dashboard">
        ...
        <div className="py-10 text-center">
          <div className="px-6">
            <div className="flex gap-3 items-center">
              <div className="flex-1 text-left">
                ...
                <input
                  onChange={(e) =>
                    setCollaboratorsField([
                      { ...collaboratorsField[0], name: e.target.value },
                    ])
                  }
                  value={collaboratorsField[0].name}
                  name="name"
                  placeholder="Enter full name"
                  className={`w-full px-3.5 py-2.5 bg-white rounded-lg shadow border border-gray-300 text-gray-500`}
                />
              ...
              <div className="flex-1 text-left">
                ...
                <input
                  onChange={(e) =>
                    setCollaboratorsField([
                      { ...collaboratorsField[0], email: e.target.value },
                    ])
                  }
                  value={collaboratorsField[0].email}
                  name="email"
                  placeholder="Enter your email"
                  className={`w-full px-3.5 py-2.5 bg-white rounded-lg shadow border border-gray-300 text-gray-500`}
                />
              ...
              <div className="flex-1 text-left">
                ...
                <select
                  onChange={(e) =>
                    setCollaboratorsField([
                      { ...collaboratorsField[0], role: e.target.value },
                    ])
                  }
                  value={collaboratorsField[0].role}
                  name="email"
                  placeholder="olivia@gmail.com"
                  className={`w-full px-3.5 py-2.5 bg-white rounded-lg shadow border border-gray-300 text-gray-500`}
                >
              ...
              <div>
                <button>
                  ...
                  >
                    <path
                      d="M4.16675 15.8327L15.8334 4.16602M4.16675 4.16602L15.8334 15.8327L4.16675 4.16602Z"
                      stroke="#98A2B3"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
          ...
          <div className="mt-8 space-y-4 w-5/12 mx-auto">
            ...
            <div>
              <Button
                onClick={handleSendInvite}
                className="w-full !from-white !to-white !text-[#063150] font-semibold !py-[0.63rem] text-center"
              >
                {loading ? (
                  <svg
                    className="w-5 h-5 inline"
      ...
      <div className="relative">
        <div className="flex gap-3 items-center">
          <div className="text-sm font-medium">{user?.first_name} Podcast</div>
          <div>
            <svg
              width="16"
              height="16"
        ...
        <div className="pr-5 mt-5">
          ...
          <div>
            <p className="text-sm">
              Collaborators listed here are granted full editorial control over
              the podcast.
            </p>
          </div>
        </div>
      ...
      <div className="mt-8">
        <div className="flex justify-between">
          <div>
            <div className="font-semibold text-lg">Collaborators</div>
            <div>
              <p className="text-xs text-[#F2F4F7]">
                Detailed list of collaborators on this podcast
              </p>
            </div>
          </div>
        ...
        <CollaboratorsTable
          ...
          onCreateCollaborator={() => setShowModal(true)}
          update={handleGetCollborators}
        />
      </div>
    </div>
  );

...
export const EpisodeItem: React.FC<{
  mode: "list" | "card";
  episode: EpisodeModel;
  isArchive: boolean;
}> = ({ mode, episode, isArchive }) => {
  const [selectedEpisode, setSelectedEpisode] = useState<EpisodeModel | null>(
    null
  );
  ...
  const handleArchive = async () => {
    try {
      ...
      const response = await APICall(
        archiveEpisode,
        [selectedEpisode?.podcast_id, selectedEpisode?.id],
        true
      );
  ...
  return (
    <>
      <Modal
        ...
        onClose={(val) => setShowArchiveModal(val)}
      >
        ...
        <div className="py-4 text-center">
          <div className="">
            <Button
              onClick={isArchive ? handleUnarchive : handleArchive}
                ...
                <div className="flex justify-between flex-col gap-2">
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <div className="flex items-center gap-1 text-sm">
                      ...
                      <div>{episode.play_count} Plays</div>
                    </div>
                    <div className="flex items-center gap-1 text-sm">
                      <svg
                        width="16"
                      ...
                      <div>{formatTimeW(episode.duration)}</div>
                    </div>
                    <div className="flex items-center gap-1 text-sm">
                      <div>₦</div>
                      <div>0</div>
            ...
            <div className="flex gap-12 self-center">
              <div className="text-center">
                <Link
                  ...
                  href={`/podcast/edit-episode/${episode.podcast_id}/${episode.id}`}
                >
                  <div>
                    <svg
                      className="inline"
...
export const EpisodeTableItem: React.FC<{
  episode: EpisodeModel;
  isArchive: boolean;
}> = ({ episode, isArchive }) => {
    ...
    <>
      ...
      <tr>
        ...
        <td className="py-4 border-b pl-6 text-xs border-t border-[#667085] ">
          <div className="">
            <span
              className={`capitalize inline-flex gap-1 text-xs font-medium rounded-full py-[6px] px-3 ${
                episode.status.toLowerCase() == "published"
                  ? "text-green-500 bg-green-100"
                  : "text-[#7A271A] bg-[#FECDCA]"
              }  items-center`}
            >
        ...
        <td className="py-4 border-b pl-6 text-xs font-medium border-t border-[#667085] ">
          <span
            className={`capitalize inline-flex gap-1 text-xs font-medium rounded-full py-[6px] px-3 ${
              episode.visibility.toLowerCase() == "public"
                ? "text-[#2B4212] bg-[#CEEAB0]"
                : "text-[#101323] bg-[#D5D9EB]"
            }  items-center`}
          >
        ...
        <td className="py-4 border-b pl-6 text-xs border-t border-[#667085] ">
          <div className="">{formatTimeW(episode.duration)}</div>
        </td>
            ...
            <div className="flex">
              <Popover as={"div"} className="relative">
                <Popover.Button ref={setReferenceElement} className="">
                  ...
                  >
                    <path
                      d="M16.0002 10.6663C17.4668 10.6663 18.6668 9.46634 18.6668 7.99967C18.6668 6.53301 17.4668 5.33301 16.0002 5.33301C14.5335 5.33301 13.3335 6.53301 13.3335 7.99967C13.3335 9.46634 14.5335 10.6663 16.0002 10.6663ZM16.0002 13.333C14.5335 13.333 13.3335 14.533 13.3335 15.9997C13.3335 17.4663 14.5335 18.6663 16.0002 18.6663C17.4668 18.6663 18.6668 17.4663 18.6668 15.9997C18.6668 14.533 17.4668 13.333 16.0002 13.333ZM16.0002 21.333C14.5335 21.333 13.3335 22.533 13.3335 23.9997C13.3335 25.4663 14.5335 26.6663 16.0002 26.6663C17.4668 26.6663 18.6668 25.4663 18.6668 23.9997C18.6668 22.533 17.4668 21.333 16.0002 21.333Z"
                      fill="#F2F4F7"
                    />
                  </svg>
                </Popover.Button>
                ...
                >
                  <div className="p-2">
                    <div className={``}>
                      <Link
                        className="block py-[0.63rem] px-2 rounded-lg hover:bg-[#1D2939] cursor-pointer "
                        href={
                          isArchive
                            ? `/podcast/edit-episode/${episode.podcast_id}/${episode.id}/archive`
                            : `/podcast/edit-episode/${episode.podcast_id}/${episode.id}`
                        }
                      >
                        Edit
                      </Link>
            ...
            <table className="border-collapse table-auto w-full whitespace-nowrap">
              <thead className="bg-[#101828] rounded-t-lg text-base  text-white text-left border-none">
                <tr>
                  ...
                  <th className="py-4 pl-6 font-medium text-xs">
                    Date published
                  </th>
...
export const EpisodeView: React.FC<{
  ...
  const handleGetEpisodes = async (title: string, page?: number) => {
    try {
      setSearch(title);
      const response = await APICall(
        isArchive ? getArchivedEpisodes : getEpisodes,
        [page ? page : currentPage, 15, title]
      );
    ...
    try {
      switch (v.id) {
        ...
        case 3: {
          ...
          setEpisodes(
            _episodes.sort(
              (a, b) => Number(a.play_count) - Number(b.play_count)
            )
          );
          break;
        }
            ...
            <div className="">
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Search"
                  className="text-lg w-[292px] placeholder:text-[#98A2B3] pl-10 pr-3 py-2 rounded-lg border border-gray-300 bg-transparent"
                />
              </div>
            </div>
          </div>
        ...
        {episodes.length ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-lg font-medium mt-4">
              {isArchive
                ? "There are no archived episodes"
            ...
            <div className="mt-4">
              <Button
                onClick={() => {
                  isArchive
                    ? setSelectedStatusFilter(statusFilter[0])
                    : router.push("/podcast/create-episod");
                }}
                className="text-sm"
              >
...
export const EpisodeLiveViewItem: React.FC<{
  mode: "list" | "card";
  episode: EpisodeModel;
  isArchive: boolean;
}> = ({ mode, episode, isArchive }) => {
  ...
  return (
    <tr className="bg-[#292929] text-white my-3 ">
      <td className="text-white rounded-l-lg px-5 py-3 font-medium my-3 flex flex-row justify-start items-center gap-3">
        ...
        >
          <rect
            ...
            height="32"
            rx="16"
            fill="url(#paint0_linear_6057_59739)"
          />
          <path
            d="M20.1175 14.2002L11.2 19.5777C10.675 19.8927 10 19.5177 10 18.9027V12.9027C10 10.2852 12.8275 8.65022 15.1 9.95522L18.5425 11.9352L20.11 12.8352C20.6275 13.1427 20.635 13.8927 20.1175 14.2002Z"
            fill="#E5F5F4"
          />
          <path
            d="M20.5686 18.595L17.5311 20.35L14.5011 22.0975C13.4136 22.72 12.1836 22.5925 11.2911 21.9625C10.8561 21.6625 10.9086 20.995 11.3661 20.725L20.8986 15.01C21.3486 14.74 21.9411 14.995 22.0236 15.5125C22.2111 16.675 21.7311 17.9275 20.5686 18.595Z"
            fill="#E5F5F4"
          />
          <defs>
            <linearGradient
              id="paint0_linear_6057_59739"
              x1="-0.000498336"
              y1="31.9998"
              x2="31.9996"
              y2="-0.000389615"
      ...
      <td className="py-3 pr-2 my-3 text-xs">
        {" "}
        {moment(episode?.created_at).format("ll")}
      </td>
      <td className="py-3 pr-2 text-xs font-semibold rounded-r-md">
        {convertToTimeFormat(episode?.duration)}
      </td>
    </tr>
  );
};
...
export const EpisodeLiveView: React.FC<{
  ...
  const [viewMode, setViewMode] = useState<"list" | "card">(view);
    ...
    <div className="mt-4">
      <div className="">
        {episodes.length ? (
          ...
          <p className="w-full justify-center items-center flex flex-row">
            No episode found
          </p>
        )}
      </div>
      ...
      <div className="flex justify-between items-center p-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center gap-5">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Apple podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center p-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Spotify podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center px-6 p-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen to Wokpa podcast</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center px-7 py-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen to Apple podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center px-10 py-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Google podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center px-8 py-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Boomplay podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-10 py-4 bg-[#141414] rounded-xl mb-5">
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Amazon podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-10 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Deezer podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-6 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center ">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Good podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-6 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center ">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on iHearts podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-6 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center ">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Castbox podcasts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-10 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center gap-6">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Podcast Addicts</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-10 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center gap-6">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Jiosaavn Podcast</div>
          </div>
        </div>
      </div>
      <div className="flex justify-between items-center pl-6 py-4 bg-[#141414] rounded-xl mb-5 cursor-pointer">
        <div className="flex items-center">
          ...
          <div className="text-left">
            ...
            <div className="text-xs mt-2">Listen on Podchaser Podcast</div>
          </div>
        </div>
      </div>
    </div>

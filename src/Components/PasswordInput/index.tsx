    ...
    return (
        <div className="relative ">
            <input
                ...
                onBlur={props.onBlur}
                type={!visible ? "password" : "text"} placeholder={props.placeholder} className="w-full px-3.5 py-2.5 bg-white rounded-lg shadow border border-gray-300 text-gray-500" />
            <div className="flex h-full items-center px-4 absolute top-0 right-0 text-black">
                {

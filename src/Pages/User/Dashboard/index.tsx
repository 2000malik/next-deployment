                ...
                mode == "list" ?
                    <div className="w-full flex justify-between items-center py-6">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <img className="w-[120px] h-[120px] rounded-lg" src={getImage("product.jpeg")} alt="" />
                            </div>
                            <div className="h-full">
                                <div className="flex justify-between flex-col gap-2">
                                    ...
                                    <div>
                                        <div onClick={() => navigate("/episodes/1 ")} className="font-semibold text-lg">
        ...
        <div id="dashboard">
            <div className="">
                <div className="flex justify-end gap-2">
                    ...
                    <div>
                        <Button onClick={() => navigate("/create-podcast")} className="font-semibold text-sm">
                            Create new podcast
                        </Button>
                    </div>
                </div>

                                    ...
                                    <div className="space-y-5">
                                        <div className="flex gap-3">
                                            <div>
                                                ...
                                                <Input name="email" placeholder="Enter full name" />
                                            </div>
                                            <div>
                                        ...
                                        <div className="">
                                            <div>
                                                ...
                                                <label htmlFor="password" className="text-sm ml-2">
                                                    By signing up. you are agreeing to our <Link to="/" className=" text-[#25AEA4]"> Terms & Conditions </Link> and <Link to="/" className=" text-[#25AEA4]"> Privacy Policy.</Link>
                                                </label>
                                            </div>
                                            ...
                                            <Button className="w-full !bg-white from-white to-white">
                                                <div className="flex justify-center items-center gap-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                                        <g id="Social icon" clip-path="url(#clip0_2654_70290)">
                                        ...
                                        <div className="text-center">
                                            <div className="text-sm font-normal text-gray-50">
                                                ALready have an account <Link to="/login" className="font-semibold text-base text-cyan-200 font-inter"> Log in</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                            ...
                            <div>
                                <div className="bg-[#141414] p-8 flex flex-col gap-6 rounded-xl">
                                    <div className="font-raleway text-4xl">
                                        <span className="text-white font-medium">Subscribing to  <span className="text-teal-400 font-medium ">Free</span></span>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                            <path d="M14 40V10H15L33 38H34V8M8 20H40M8 28H40" stroke="#FCFCFD" stroke-width="2" />
                                        </svg>
                                ...
                                <div className="mt-4">
                                    <div className="bg-[#141414] p-8 flex flex-col gap-6 rounded-xl">
                                        <div className="font-lg ">
                                            You're subscribing to Free. You'll be notified to upgrade your <br /> package after the 14-days free trial.
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div className="">
                                                    <div className="text-sm font-normal text-gray-50">
                                                        ...
                                                        <label htmlFor="password" className="text-sm ml-2">
                                                            I accept <Link to="/" className=" text-[#25AEA4]"> Terms & Conditions </Link> and <Link to="/" className=" text-[#25AEA4]"> Privacy Policy.</Link>
                                                        </label>
                                                    </div>
                                                </div>
                                                <Button className="">
